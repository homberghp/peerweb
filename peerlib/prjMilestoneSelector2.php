...
class PrjMilestoneSelector2 {
    ...
    /**
     *  Create a selector for a project milstone.
     * The join and whare clause can de extended. In the default query the following aliases are used:
     * <ul><li>p for project</li>
     * <li>pm for project milestone</li><li>t for tutor </li>
     * <li>fc for fontys course</li></ul>
     * @global type $_SESSION
     * @global type $_REQUEST
     * @param type $conn db connection to use
     * @param type $peer_id the loged in user
