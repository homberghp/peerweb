...
$grp_sql =
        "select afko||'.'||year||':'||'g'||to_char(pt.grp_num,'FM09')||': '||coalesce(grp_name,'')||' '||"
...
$pp['oldGroupOptionsList'] = getOptionListGrouped( $dbConn, $grp_sql,
        $oldprjtg_id );
$pp['newGroupOptionList'] = getOptionListGrouped( $dbConn, $grp_sql,
        $newprjtg_id );
