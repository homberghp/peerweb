...
define("PEERSITE","/peertest/");
define("PEERSRCPATH","$site_dir/");
include 'navtable.php';        
        
//session_start();

$xajax = new xajax(); 
include(TREEVIEW_SOURCE."/ajax/ajax.php"); //Enables real-time update. Must be called before
					   //any headers or HTML output have been sent.
$xajax->processRequests();
        
//Define identify name(s) to your treeview(s);
//Add more comma separated names to create more than one treeview.
//The treeview names must always be unique.
//You can´t even use the same treeview names on different php sites. 
...
<?php $xajax->printJavascript("/peertest/phptreeview/ajax/framework"); //Enables real-time update. ?>
