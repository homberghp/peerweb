...
function initRTE(imgPath, incPath, css, genXHTML) {
	...
	if (isRichText) document.writeln('<style type="text/css">@import "' + includesPath + 'style/rte.css";</style>');
...
function dlgInsertTable(rte, command) {
	...
	parent.command = command;
	currentRTE = rte;
	InsertTable = popUpWin(includesPath + 'insert_table.html', 'InsertTable', 460, 280, '');
}
...
function dlgInsertLink(rte, command) {
	...
	parent.command = command;
	currentRTE = rte;
	InsertLink = popUpWin(includesPath + 'insert_link.html', 'InsertLink', 460, 280, '');
