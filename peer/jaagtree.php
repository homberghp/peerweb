...
?>
<div align='center' style='margin:5px 0 5px 0;' class='<?=$tdClass?>'>Userid <?=$_SESSION['peer_id']?>,<?=$_SESSION['userCap']?></div>
...
<!--Some 'commercials'-->
   <div class='<?=$tdClass?>' style='align:center'>
      <a href='http://www.mozilla.org' target='mainframe'>
         <img src='<?=IMAGEROOT?>/product-mozilla.png' border='0' alt='best viewed with mozilla or mozilla-firefox'
        title='best viewed with mozilla or netscape navigator'/>
      </a>
   </div>
...
<!--logout-->
<div class='<?=$tdClass?>'>
    <a href='<?=$logoutlink?>' title='click me to logout' target='_top'>
