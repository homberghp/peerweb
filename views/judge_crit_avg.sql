...
--
-- Name: judge_crit_avg; Type: VIEW; Schema: public; Owner: hom
--
...
ALTER TABLE judge_crit_avg OWNER TO hom;

--
-- Name: judge_crit_avg; Type: ACL; Schema: public; Owner: hom
--

GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,UPDATE ON TABLE judge_crit_avg TO peerweb;
